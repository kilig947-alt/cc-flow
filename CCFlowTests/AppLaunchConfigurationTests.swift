...
final class AppLaunchConfigurationTests: XCTestCase {
    private func makeDefaults(testName: String = #function) -> UserDefaults {
        let suiteName = "CCFlowTests.AppLaunchConfiguration.\(testName)"
    ...
    func testUITestLaunchConfigurationDisablesSideEffectsAndShowsSettings() {
        let configuration = AppLaunchConfiguration(
            environment: ["CC_FLOW_UI_TEST_MODE": "1"],
    ...
    func testExplicitMultipleInstanceOverrideDisablesSingleInstanceEnforcement() {
        let configuration = AppLaunchConfiguration(
            environment: ["CC_FLOW_ALLOW_MULTIPLE_INSTANCES": "1"],
    ...
    func testLaunchFlowDefersSettingsWindowUntilAfterOnboardingWhenRequested() {
        let configuration = AppLaunchConfiguration(
            environment: ["CC_FLOW_SHOW_SETTINGS_ON_LAUNCH": "1"],
            isDebuggerAttached: false
        )
