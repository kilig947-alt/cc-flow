...
BRAND_LOGO_SOURCE="${CC_FLOW_DMG_LOGO_SOURCE:-${TRAE_FLOW_DMG_LOGO_SOURCE:-$PROJECT_DIR/docs/images/cc-flow-icon.png}}"
DMG_BACKGROUND_SOURCE="${CC_FLOW_DMG_BACKGROUND_SOURCE:-${TRAE_FLOW_DMG_BACKGROUND_SOURCE:-$PROJECT_DIR/docs/images/cc-flow-dmg-installer-background.png}}"
DMG_ICON_SOURCE="${CC_FLOW_DMG_ICON_SOURCE:-${TRAE_FLOW_DMG_ICON_SOURCE:-}}"
FALLBACK_ICON_PNG="$PROJECT_DIR/CCFlow/Assets.xcassets/AppIcon.appiconset/icon_1024x1024.png"

VOLNAME=""
SOURCE_DIR=""
OUTPUT_DMG=""
APP_NAME="CC FLOW.app"
WINDOW_WIDTH="${CC_FLOW_DMG_WINDOW_WIDTH:-${TRAE_FLOW_DMG_WINDOW_WIDTH:-768}}"
WINDOW_HEIGHT="${CC_FLOW_DMG_WINDOW_HEIGHT:-${TRAE_FLOW_DMG_WINDOW_HEIGHT:-512}}"
ICON_SIZE="${CC_FLOW_DMG_ICON_SIZE:-${TRAE_FLOW_DMG_ICON_SIZE:-108}}"
APP_X="${CC_FLOW_DMG_APP_X:-${TRAE_FLOW_DMG_APP_X:-212}}"
APP_Y="${CC_FLOW_DMG_APP_Y:-${TRAE_FLOW_DMG_APP_Y:-246}}"
APPLICATIONS_X="${CC_FLOW_DMG_APPLICATIONS_X:-${TRAE_FLOW_DMG_APPLICATIONS_X:-602}}"
APPLICATIONS_Y="${CC_FLOW_DMG_APPLICATIONS_Y:-${TRAE_FLOW_DMG_APPLICATIONS_Y:-248}}"
FAIL_ON_PLAIN="${CC_FLOW_DMG_FAIL_ON_PLAIN:-${TRAE_FLOW_DMG_FAIL_ON_PLAIN:-0}}"
FINDER_VOLUME_NAME=""
...
Environment:
  CC_FLOW_DMG_BACKGROUND_SOURCE    Optional background image override (TRAE_FLOW_* remains a fallback)
EOF
}
...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/cc-flow-dmg.XXXXXX")"
